...
assert(out.includes('href="/#password-access">Request Dashboard Access</a>'));
assert(!out.includes('href="/#password-access">Watch System for Free</a>'));
...
assert(out.includes("Verify your email"));
assert(out.includes("Await manual review"));
assert(out.includes("Receive your code"));
assert(out.includes("Spam/Junk"));
...
assert(!out.includes("Request 7-Day Access"));
assert(!out.includes("Watch for 7 days"));
assert(!out.includes("dashboard for 7 days"));

...
assert(out.includes('class="vx-home-how"'));
assert(out.includes('class="vx-home-compare"'));
...
const previewIndex = out.indexOf('class="vx-home-proof-preview"');
const dayIndex = out.indexOf('id="live-day-trading"');
const accessIndex = out.indexOf('id="password-access"');
assert(heroIndex < howIndex, "How It Works must follow the hero before evidence-heavy content");
assert(howIndex < compareIndex, "comparison must follow How It Works");
assert(compareIndex < selectorIndex, "category comparison heading must lead its cards");
assert(selectorIndex < previewIndex, "product/evidence preview must follow the beginner comparison");
assert(previewIndex < dayIndex, "preview must precede detailed Day Trading evidence");
assert(dayIndex < accessIndex, "Day Trading evidence must remain before the existing access form");

...
function dayTradingSection(snapshot) {
  return `<section class="vx-home-day-trading" aria-labelledby="vx-home-day-title"><div class="wrap">
    <div class="vx-home-day-head"><div class="vx-home-day-copy"><div class="vx-home-day-kicker">Live Day Trading</div><h2 id="vx-home-day-title">Day Trading System Status</h2><p><span class="vx-home-day-subtitle-line">Current status and realized performance for Vixale day-trading systems.</span><span class="vx-home-day-subtitle-line">Swing Trading and Options are presented separately.</span></p></div><div class="vx-home-day-actions"><div class="vx-home-day-action-row">${statusBadge(snapshot)}<a class="vx-home-day-watch-btn" href="/#password-access">Watch the System Live</a></div><a class="vx-home-day-dashboard-link" href="/dashboard">Already have access? Open Dashboard →</a><a class="vx-home-day-details-link" href="${DAY_TRADING_PATH}">Day Trading details →</a></div></div>

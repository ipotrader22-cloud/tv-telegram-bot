...
function dayTradingSection(snapshot) {
  return `<section class="vx-home-day-trading" aria-labelledby="vx-home-day-title"><div class="wrap">
    <div class="vx-home-day-head"><div class="vx-home-day-copy"><div class="vx-home-day-kicker">Live Day Trading</div><h2 id="vx-home-day-title">Day Trading System Status</h2><p><span class="vx-home-day-subtitle-line">Current status and realized performance for Vixale day-trading systems.</span><span class="vx-home-day-subtitle-line">Swing Trading and Options are presented separately.</span></p></div><div class="vx-home-day-actions"><div class="vx-home-day-action-row">${statusBadge(snapshot)}<a class="vx-home-day-watch-btn" href="/#password-access">Request Dashboard Access</a></div><a class="vx-home-day-dashboard-link" href="/dashboard">Already have access? Open Dashboard →</a><a class="vx-home-day-details-link" href="${DAY_TRADING_PATH}">Day Trading details →</a></div></div>
...
<style id="${STYLE_ID}">
  ...
  .vx-home-day-subtitle-line{display:block}
  .vx-home-day-actions{display:flex;min-width:330px;flex-direction:column;align-items:flex-end;gap:8px}
  .vx-home-day-action-row{display:flex;align-items:center;justify-content:flex-end;gap:10px}
  .vx-home-day-watch-btn{display:inline-flex;align-items:center;justify-content:center;min-height:42px;padding:0 18px;border:1px solid #078f51;border-radius:999px;background:#078f51;color:#fff;text-decoration:none;font-size:12.5px;font-weight:700;box-shadow:0 10px 24px rgba(7,143,81,.14);transition:transform .16s ease,box-shadow .16s ease}
  .vx-home-day-watch-btn:hover{transform:translateY(-1px);box-shadow:0 12px 28px rgba(7,143,81,.18)}
  .vx-home-day-dashboard-link{color:#4f5d57;font-size:12px;font-weight:650;text-decoration:none}.vx-home-day-dashboard-link:hover{text-decoration:underline;text-underline-offset:3px}
  .vx-home-day-details-link{color:#87918d;font-size:11px;font-weight:600;text-decoration:none}.vx-home-day-details-link:hover{text-decoration:underline;text-underline-offset:3px}
  ...
  @media(max-width:900px){.vx-home-day-head{align-items:flex-start;flex-direction:column}.vx-home-day-actions{min-width:0;align-items:flex-start}.vx-home-day-action-row{justify-content:flex-start}.vx-home-live-strip{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media(max-width:640px){.vx-home-day-trading{padding:38px 0 46px}.vx-home-day-trading>.wrap{padding:0 16px}.vx-home-day-actions{width:100%;gap:10px}.vx-home-day-action-row{width:100%;flex-direction:column;align-items:stretch;gap:10px}.vx-home-day-badge{align-self:flex-start}.vx-home-day-watch-btn{width:100%;min-height:48px;box-sizing:border-box}.vx-home-day-dashboard-link{font-size:12.5px}.vx-home-live-strip{gap:9px}.vx-home-live-card{min-height:92px;padding:16px 13px;border-radius:18px}.vx-home-live-label{font-size:9.5px;white-space:normal}.vx-home-live-value{font-size:21px}.vx-home-equity-preview{padding:18px 16px 14px;border-radius:22px}.vx-home-equity-head{flex-direction:column}.vx-home-equity-total{text-align:left}.vx-home-equity-stage,.vx-home-equity-svg,.vx-home-equity-empty{min-height:235px}.vx-home-equity-foot{align-items:flex-start;flex-direction:column}.vx-home-other-grid{grid-template-columns:1fr}.vx-home-system-card{min-height:130px}}
</style>`;
...
(() => {
  ...
  const dateLabel=value=>{const m=String(value||'').match(/^(\\d{4})-(\\d{2})-(\\d{2})$/);if(!m)return value;return new Intl.DateTimeFormat('en-US',{month:'short',day:'numeric',timeZone:'UTC'}).format(new Date(Date.UTC(+m[1],+m[2]-1,+m[3])));};
...
module.exports = {
  ...
  refineTelegramNav, findTagRangeFromOpen, findTagByClass, dateLabel, summaryStrip, renderServerEquitySvg,

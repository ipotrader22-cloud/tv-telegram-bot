...
function pricingContent() {
  ...
  <div id="vx-watch-status" class="vx-perf-status"><span><strong>Loading verified performance</strong></span><span>Closed Trades only · Open P&amp;L excluded</span></div><div class="vx-perf-cta"><div><strong>Want to see the system operating live?</strong><span>Watch the read-only dashboard before deciding what to do next.</span></div><a class="vx-watch-btn primary" href="/access">Request Free Access</a></div></section>

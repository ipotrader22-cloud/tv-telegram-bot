...
function pricingContent() {
  ...
  <div id="vx-watch-status" class="vx-perf-status"><span><strong>Loading verified performance</strong></span><span>Closed Trades only · Open P&amp;L excluded</span></div><div class="vx-perf-cta"><div><strong>Want to see the system operating live?</strong><span>Watch the read-only dashboard before deciding what to do next.</span></div><a class="vx-watch-btn primary" href="/#password-access">Request Dashboard Access</a></div></section>
  <div class="vx-watch-steps"><div class="vx-watch-step"><b>1</b><div><strong>Request access</strong><span>Send the short access form.</span></div></div><div class="vx-watch-step"><b>2</b><div><strong>Verify your email</strong><span>Use the one-time link we send. Check Inbox and Spam/Junk if you do not see it.</span></div></div><div class="vx-watch-step"><b>3</b><div><strong>Await manual review</strong><span>Verified requests are reviewed manually. Access is not automatic.</span></div></div><div class="vx-watch-step"><b>4</b><div><strong>Receive your code</strong><span>If approved, we'll email your individual viewer code.</span></div></div></div>
